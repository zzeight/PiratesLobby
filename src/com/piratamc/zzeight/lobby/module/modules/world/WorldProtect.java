...
public class WorldProtect extends Module {
    ...
    public WorldProtect(PiratesLobby plugin) {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (player.hasPermission(PermissionsHub.EVENT_BLOCK_BREAK.getPermission())) return;
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        if (player.hasPermission(PermissionsHub.EVENT_BLOCK_PLACE.getPermission())) return;
    ...
    public void onEntityInteract(PlayerInteractEntityEvent event) {
        ...
        if (player.hasPermission(PermissionsHub.EVENT_BLOCK_INTERACT.getPermission())) return;
    ...
    public void onPlayerDropEvent(PlayerDropItemEvent event) {
        ...
        if (inDisabledWorld(player.getLocation())) return;
        if (player.hasPermission(PermissionsHub.EVENT_ITEM_DROP.getPermission())) return;
    ...
    public void onPlayerPickupEvent(PlayerPickupItemEvent event) {
        ...
        Player player = event.getPlayer();
        if (inDisabledWorld(player.getLocation())) return;
        if (player.hasPermission(PermissionsHub.EVENT_ITEM_PICKUP.getPermission())) return;
    ...
    public void onEntityDamage(EntityDamageByEntityEvent event) {
        ...
        if (event.getDamager().hasPermission(PermissionsHub.EVENT_PLAYER_PVP.getPermission())) return;
