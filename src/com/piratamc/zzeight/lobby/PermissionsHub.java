...
public enum PermissionsHub {
	
	// Permissões Comandos
	COMMAND_PIRATESHUB_HELP("command.help"),
    COMMAND_PIRATESHUB_RELOAD("command.reload"),
    ...
    PermissionsHub(String perm) {
        this.perm = perm;
    }

    public final String getPermission() {
        return "pirateshub." + this.perm;
    }
