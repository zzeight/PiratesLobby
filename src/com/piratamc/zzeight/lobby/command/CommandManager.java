package com.piratamc.zzeight.lobby.command;

import cl.bgm.bukkit.util.*;
...
import com.piratamc.zzeight.lobby.command.commands.*;
import com.piratamc.zzeight.lobby.command.commands.gamemode.*;
...
public class CommandManager {
    ...
    public CommandManager(PiratesLobby plugin) {
        this.plugin = plugin;
    ...
    public void reload() {
        ...
        commandRegistry.register(PiratesLobbyCommand.class);
